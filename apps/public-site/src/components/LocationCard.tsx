...
const LocationCard = ({ location }: LocationCardProps) => {
  ...
  return (
    <div className="overflow-hidden hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-gray-900/50 transition-all duration-200 relative group bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
